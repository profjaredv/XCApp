...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // max-h + overflow are load-bearing, not polish: without them a
        // dialog taller than the viewport (a group with 15 members, a long
        // roster picker) is centered with translate-y-[-50%], so it runs off
        // BOTH the top and bottom of the screen with no scroll container,
